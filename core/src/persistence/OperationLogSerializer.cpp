...
std::vector<uint8_t> OperationLogSerializer::serializeAll(const std::vector<OperationBody>& toSerialize) {
...
std::vector<uint8_t> OperationLogSerializer::serialize(std::vector<uint8_t>& serializedOut, const OperationBody& toDeserialize) {
    //Operator number
...
void OperationLogSerializer::writePadding(std::vector<uint8_t>& buffer) {
