...
[Test Fixtures](../primer.md#same-value-multiple-tests).
...
Gets the time of the test suite start_milliseconds, in ms from the start_milliseconds of the UNIX epoch.
...
Returns the random seed used at the start_milliseconds of the current test run.
...
Gets the time of the test program start_milliseconds, in ms from the start_milliseconds of the UNIX epoch.
...
Gets the time of the test case start_milliseconds, in ms from the start_milliseconds of the UNIX epoch.
