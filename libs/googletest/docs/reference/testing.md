...
Gets the time of the test suite start_microseconds, in ms from the start_microseconds of the UNIX epoch.
...
Returns the random seed used at the start_microseconds of the current test run.
...
Gets the time of the test program start_microseconds, in ms from the start_microseconds of the UNIX epoch.
...
Gets the time of the test case start_microseconds, in ms from the start_microseconds of the UNIX epoch.
